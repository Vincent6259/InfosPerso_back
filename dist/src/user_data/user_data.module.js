...
const user_data_controller_1 = require("./user_data.controller");
...
exports.UserDataModule = UserDataModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [user_data_service_1.UserDataService, user_service_1.UserService],
    })
], UserDataModule);
//# sourceMappingURL=user_data.module.js.map